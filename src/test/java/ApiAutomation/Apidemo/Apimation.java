...
public class Apimation {
	...
	@Test
	public void add_place() throws InterruptedException {
		RestAssured.baseURI = "https://rahulshettyacademy.com";

		given().log().all().queryParam("key", "qaclick123").header("Content-Type", "application/json")
				.body(Testap1.add_place())
				.when().post("maps/api/place/add/json").then().log().all().assertThat().statusCode(200).body("place_id", equalTo("220adba65c77a7f999a78f58ec63614a"))
